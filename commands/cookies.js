...
const failurePhrases = [
  ...
  `you move stealthily as a cat, carefully not to make any sound, only to slip on a banana peel and hit the cabinet full of pans. You end up waking up the entire FC house.`,
